...
const SidebarSubmenuItem = ({
  ...
  return (
    <div
      className={cn(
        "group flex items-center pl-10 pr-4 py-2.5 text-sm font-medium cursor-pointer",
        isActive
          ? "bg-primary-light border-l-2 border-primary text-primary"
          : "text-gray-700 hover:bg-gray-50 hover:border-l-2 hover:border-primary hover:text-primary"
      )}
    ...
    <aside className={cn("w-48 bg-white h-screen overflow-y-auto flex-shrink-0 flex flex-col relative", className)}>
      ...
      <div className="mt-4 flex-1">
        <SidebarItem
          ...
          isActive={location === "/company/dashboard"}
          isMobile={isMobile}
        ...
        <SidebarItem
          ...
          isActive={location === "/company/employees"}
          isMobile={isMobile}
          onClick={handleItemClick}
        >
          All Employees
        ...
        <SidebarItem
          ...
          isActive={location === "/company/departments"}
          isMobile={isMobile}
          onClick={handleItemClick}
        >
          All Departments
        ...
        <SidebarItem
          ...
          isActive={location === "/company/attendance"}
          isMobile={isMobile}
          onClick={handleItemClick}
        >
          Attendance
        ...
        <SidebarItem
          ...
          isActive={location === "/company/payroll"}
          isMobile={isMobile}
          onClick={handleItemClick}
        >
          Payroll
        ...
        <SidebarItem
          ...
          isActive={location.includes("/company/recruitment") || location.includes("/company/jobs") || location === "/company/candidates"}
          isMobile={isMobile}
        ...
        {recruitmentOpen && (
          <>
            <SidebarSubmenuItem
              ...
              isActive={location === "/company/jobs"}
              onClick={handleItemClick}
            >
              Jobs
            </SidebarSubmenuItem>
            ...
            <SidebarSubmenuItem
              ...
              isActive={location === "/company/candidates"}
              onClick={handleItemClick}
            >
              Candidates
            </SidebarSubmenuItem>
        ...
        <SidebarItem
          ...
          isActive={location === "/company/leaves"}
          isMobile={isMobile}
          onClick={handleItemClick}
        >
          Leaves
        ...
        <SidebarItem
          ...
          icon={<Calendar className="h-5 w-5" />}
          isActive={location === "/company/holidays"}
          isMobile={isMobile}
          onClick={handleItemClick}
        >
          Holidays
